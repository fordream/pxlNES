...
const int32 pre_op_list[] = {
    ...
    14, ASL, ABSOLUTE,          16, BPL, IMPLICIT,              17, ORA, INDIRECT_Y,            21, ORA, ZERO_PAGE_X, 
    ...
    48, BMI, IMPLICIT,          49, AND, INDIRECT_Y,            53, AND, ZERO_PAGE_X,           54, ROL, ZERO_PAGE_X, 
    ...
    77, EOR, ABSOLUTE,          78, LSR, ABSOLUTE,              80, BVC, IMPLICIT,              81, EOR, INDIRECT_Y, 
    ...
    112, BVS, IMPLICIT,         113, ADC, INDIRECT_Y,           117, ADC, ZERO_PAGE_X,          118, ROR, ZERO_PAGE_X, 
    ...
    142, STX, ABSOLUTE,         144, BCC, IMPLICIT,             145, STA, INDIRECT_Y,           148, STY, ZERO_PAGE_X, 
    ...
    173, LDA, ABSOLUTE,         174, LDX, ABSOLUTE,             176, BCS, IMPLICIT,             177, LDA, INDIRECT_Y, 
    ...
    208, BNE, IMPLICIT,         209, CMP, INDIRECT_Y,           213, CMP, ZERO_PAGE_X,          214, DEC, ZERO_PAGE_X, 
    ...
    236, CPX, ABSOLUTE,         237, SBC, ABSOLUTE,             238, INC, ABSOLUTE,             240, BEQ, IMPLICIT, 
